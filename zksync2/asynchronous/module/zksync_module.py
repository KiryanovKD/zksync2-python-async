...
from zksync2.shared.core.types import Limit, From, ContractSourceDebugInfo, \
...
class AsyncZkSync(AsyncEth, ABC):
    ...
    def __init__(self, web3: "AsyncWeb3"):
        super(AsyncZkSync, self).__init__(web3)
    ...
    async def get_l2_transaction_from_priority_op(self, tx_receipt, main_contract: ZkSyncContract):
    ...
    async def get_priority_op_response(self, tx_receipt, main_contract: ZkSyncContract):
