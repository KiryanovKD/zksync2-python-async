...
from zksync2.shared.manage_contracts.abi import contract_deployer_abi_default
from zksync2.shared.core.utils import pad_front_bytes, to_bytes, int_to_bytes, hash_byte_code
...
class PrecomputeContractDeployer:
    ...
    def __init__(self, web3: Union[Web3, AsyncWeb3], abi: Optional[dict] = None):
        self.web3 = web3
        if abi is None:
