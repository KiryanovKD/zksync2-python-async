...
from zksync2_async.core.types import Token, BridgeAddresses, L2_ETH_TOKEN_ADDRESS
...
from zksync2_async.manage_contracts.eth_token import AsyncEthToken
from zksync2_async.manage_contracts.l2_bridge import AsyncL2Bridge
from zksync2_async.transaction.transaction712 import Transaction712
from zksync2_async.core.request_types import EIP712Meta, TransactionType, Transaction as ZkTx
...
class TxCreateContract(TxBase, ABC):
    ...
    def __init__(self,
        ...
        contract_deployer = AsyncPrecomputeContractDeployer(web3)
        ...
        super(TxCreateContract, self).__init__(trans={
            ...
            "nonce": nonce,
            "from": from_,
            "to": AsyncZkSyncWeb3.to_checksum_address(ZkSyncAddresses.CONTRACT_DEPLOYER_ADDRESS.value),
            "gas": gas_limit,
            "gasPrice": gas_price,
            "maxPriorityFeePerGas": max_priority_fee_per_gas,
            "value": value,
...
class TxWithdraw(TxBase, ABC):
    ...
    def __init__(self,
        ...
        if token.is_eth():
            eth_l2_token = AsyncEthToken(web3=web3.zksync,
            ...
            l2_bridge = AsyncL2Bridge(contract_address=bridge_address,
                                      web3_zks=web3,
